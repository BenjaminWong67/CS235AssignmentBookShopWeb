...
def register():
    ...
    if form_register.validate_on_submit():
        ...
        try:
            services.add_user(form_register.user_name.data, form_register.password.data, repo.repo_instance)
...
def login():
    ...
    if form_login.validate_on_submit():
        ...
        try:
            user = services.get_user(form_login.user_name.data, repo.repo_instance)

            # Authenticate user.
            services.authenticate_user(user['user_name'], form_login.password.data, repo.repo_instance)
